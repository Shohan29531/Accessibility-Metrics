...
## Calculates their differences and saves a diff image
## Reopens the diff image and finds the boxes in the image
## Draws the bounding rects and saves the image again
